...
with DAG(
    ...
    # Task Group 1: Pull from GCS
    with TaskGroup("pull_from_gcs_group") as pull_from_gcs_group:
    ...
    # Task Group 2: Sampling and Concatenation
    with TaskGroup("sampling_and_concatenation_group") as sampling_and_concatenation_group:
        previous_task = None
    ...
    # Task Group 3: Push to GCS
    with TaskGroup("push_to_gcs_group") as push_to_gcs_group:
    ...
    pull_from_gcs_group >> sampling_and_concatenation_group >> push_to_gcs_group
