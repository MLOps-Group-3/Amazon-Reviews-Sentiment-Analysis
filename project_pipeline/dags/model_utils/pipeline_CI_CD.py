...
def main():
    ...
    # credentials_path = '/media/hrs/Storage/ubuntu_repo/Amazon-Reviews-Sentiment-Analysis/project_pipeline/config/amazonreviewssentimentanalysis-8dfde6e21c1d.json'  # Path to your service account credentials
    credentials_path = 'gcp-key.json'  # Path to your service account credentials
    ...
    # Step 2: Define your pipeline function elsewhere (or import it here)
    # Ensure that model_pipeline is already defined or imported before calling it

    # Step 3: Submit the pipeline to Vertex AI
